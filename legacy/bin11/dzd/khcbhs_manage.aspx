<%@ Page language="c#" Codebehind="khcbhs_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.khcbhs_manage" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">客户查询</font></td>
							</tr>
						</table>
					</td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					...
					<TD align="right"><asp:button id="query" runat="server" Text="查询" Width="56px" CssClass="buttoncss" Height="24px"></asp:button>&nbsp;
						...
						<asp:button id="change" runat="server" Text="对帐确认" Width="64px" CssClass="buttoncss" Height="24"></asp:button>&nbsp;<asp:button id="delete" runat="server" Text="打印明细" Width="80px" CssClass="buttoncss" Height="24px"></asp:button>&nbsp;</TD>
				</TR>
			</table>
			<TABLE class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" Width="100%" CssClass="title3" Height="0px" BorderColor="#000066"
							DataKeyField="zdbm" AutoGenerateColumns="False" PageSize="50">
							...
							<Columns>
								...
								<asp:BoundColumn Visible="False" DataField="xsid" HeaderText="xsid"></asp:BoundColumn>
								...
								<asp:BoundColumn DataField="出库数量" HeaderText="出库数量" DataFormatString="{0:F2}">
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="零售价" HeaderText="单价" DataFormatString="{0:F2}"></asp:BoundColumn>
								<asp:BoundColumn DataField="金额" HeaderText="销售金额" DataFormatString="{0:F2}"></asp:BoundColumn>
								<asp:BoundColumn DataField="进货价" HeaderText="进货单价" DataFormatString="{0:F2}"></asp:BoundColumn>
								<asp:BoundColumn DataField="成本金额" HeaderText="成本金额" DataFormatString="{0:F2}"></asp:BoundColumn>
