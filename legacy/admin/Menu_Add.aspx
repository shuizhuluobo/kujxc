<%@ Page language="c#" Codebehind="Menu_Add.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.Menu_Add" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="5" border="0" width="100%" class="title3">
				<tr>
					...
					<td>
						<asp:TextBox id="id" runat="server" Width="56px" CssClass="inputcss"></asp:TextBox></td>
				</tr>
				<tr>
					<td align="right" width="100">
						描述
				...
				<tr>
					...
					<td style="HEIGHT: 3px">
						<asp:TextBox id="parentid" runat="server" Width="56px" CssClass="inputcss"></asp:TextBox></td>
				</tr>
				<tr>
					<td align="right" width="100">
						级别
					...
					<td>
						<asp:TextBox id="rank" runat="server" Width="56px" CssClass="inputcss"></asp:TextBox></td>
				</tr>
				<tr>
					<td align="right" width="100">
						图标路径
