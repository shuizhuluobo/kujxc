<%@ Page language="c#" Codebehind="Base_Change.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.Base_Change" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="5" border="0" width="100%" class="title3">
				<tr>
					...
					<td>
						<asp:TextBox id="listid" runat="server" CssClass="inputcss" Width="112px" Enabled="False"></asp:TextBox></td>
				</tr>
				<tr>
					<td align="right" width="100">
						序号
					...
					<td>
						<asp:TextBox id="sortid" runat="server" CssClass="inputcss" Width="64px" Enabled="False"></asp:TextBox></td>
				</tr>
				<tr>
