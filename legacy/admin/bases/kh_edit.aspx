<%@ Page language="c#" Codebehind="kh_edit.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.kh_edit" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="5" border="0" width="90%" align="center" class="title3">
				<TR>
					<TD align="right" width="100"><FONT face="宋体">客户编码</FONT></TD>
					<TD><FONT face="宋体">
							<asp:TextBox id="khid" runat="server" CssClass="inputcss" Width="280px"></asp:TextBox>
