<%@ Page language="c#" Codebehind="role_set.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.role_set" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">角色表设置</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
				...
				<TR>
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" PageSize="50" Width="100%" Height="80px" AutoGenerateColumns="False"
							CssClass="title3" DataKeyField="roleid" AllowPaging="True" BorderColor="#000066">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="roleid" HeaderText="编号"></asp:BoundColumn>
								<asp:BoundColumn DataField="role" HeaderText="类型名"></asp:BoundColumn>
							</Columns>
