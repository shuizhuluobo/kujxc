...
namespace jxc.admin.bases
{
	...
	/// gys_manage 的摘要说明。
	/// </summary>
	public class gys_manage : System.Web.UI.Page
	{
		...
		{
			string cmd = "select * from 基础信息_供应商资料 where 1=1  ";
			if (this.cpname.Text != string.Empty)
				cmd += " and 供应商名称 like '%" + this.cpname.Text.Trim () + "%'";
//			if (this.DropDownList1.SelectedIndex==0)
//				cmd+=" and 是否下柜='否'";
//			if (this.DropDownList1.SelectedIndex==1)
//				cmd+=" and 是否下柜='是'";

			DataSet ds = DBBase.ExecuteSql4Ds (cmd+" order by 地区,供应商名称 desc","gys");
		...
		private void add_Click(object sender, System.EventArgs e)
		{
			...
			u.OpenIEWindowRight(this,"gys_edit.aspx",500,500);
		...
		{
			string id = utils.FindFirstCheckedItem(this.Datagrid1);
			u.OpenIEWindowRight(this,"gys_edit.aspx?gysid=" + id,500,500);
		}
		...
		private void delete_Click(object sender, System.EventArgs e)
		{
			...
			//u.OpenIEWindowRight(this,"yplbsz_edit.aspx?cpid=" + id,500,500);
						string cmd="update 基础信息_供应商资料 set 状态='停用' where 供应商ID='"+id+"'";
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
            ...
            cmd[0]="update 基础信息_供应商资料 set 状态='停用' where 供应商ID='"+id+"'";
			cmd[1]="delete 基础信息_供应商资料 where 供应商ID='"+id+"'";
