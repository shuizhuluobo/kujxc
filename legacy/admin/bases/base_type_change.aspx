<%@ Page language="c#" Codebehind="base_type_change.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.base_type_change" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="5" border="0" width="100%" class="title3">
				<tr>
					...
					<td>
						<asp:TextBox id="sortname" runat="server" CssClass="inputcss" Width="64px"></asp:TextBox></td>
				</tr>
				<tr>
					...
					<td style="HEIGHT: 3px">
						<asp:TextBox id="remark" runat="server" CssClass="inputcss" Width="208px"></asp:TextBox></td>
				</tr>
			</table>
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
