<%@ Page language="c#" Codebehind="BigClass_Manage.aspx.cs" AutoEventWireup="false" Inherits="CNC.admin.bases.BigClass_Manage" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">业务大类设置</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
				...
				<TR>
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" PageSize="50" Width="100%" Height="80px" AutoGenerateColumns="False"
							CssClass="title3" DataKeyField="bigid" AllowPaging="True" BorderColor="#000066">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="bigid" HeaderText="编号"></asp:BoundColumn>
								<asp:BoundColumn DataField="bigname" HeaderText="名称"></asp:BoundColumn>
								<asp:BoundColumn DataField="begindate" HeaderText="开始日期"></asp:BoundColumn>
								<asp:BoundColumn DataField="enddate" HeaderText="结束日期"></asp:BoundColumn>
								<asp:BoundColumn DataField="ynstop" HeaderText="是否使用"></asp:BoundColumn>
