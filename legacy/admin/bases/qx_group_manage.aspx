...
<%@ Page language="c#" Codebehind="qx_group_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.qx_group_manage" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">权限组功能设计</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
					...
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" PageSize="50" Width="100%" Height="80px" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="groupname" HeaderText="组名"></asp:BoundColumn>
								<asp:BoundColumn DataField="des1" HeaderText="菜单名"></asp:BoundColumn>
								<asp:BoundColumn DataField="des2" HeaderText="上级菜单"></asp:BoundColumn>
								<asp:BoundColumn DataField="rank" HeaderText="级别"></asp:BoundColumn>
							</Columns>
