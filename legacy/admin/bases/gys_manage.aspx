...
<%@ Page language="c#" Codebehind="gys_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.gys_manage" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">供应商信息</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Width="100%" Height="80px" BorderColor="#000066"
							AllowPaging="True" DataKeyField="供应商ID" AutoGenerateColumns="False" PageSize="50" CellPadding="0">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="供应商ID" HeaderText="供应商ID"></asp:BoundColumn>
								<asp:BoundColumn DataField="地区" HeaderText="地区"></asp:BoundColumn>
								<asp:BoundColumn DataField="供应商名称" HeaderText="供应商名称"></asp:BoundColumn>
