<%@ Page language="c#" Codebehind="base_type_add.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.base_type_add" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="5" border="0" width="100%" class="title3">
				<tr>
					...
					<td>
						<asp:TextBox id="sortname" runat="server" CssClass="inputcss" Width="160px"></asp:TextBox></td>
				</tr>
				<tr>
