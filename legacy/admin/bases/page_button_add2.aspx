<%@ Page language="c#" Codebehind="page_button_add2.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.page_button_add2" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">页面按钮设置</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table cellpadding="0" cellspacing="5" border="0" width="100%" class="title3">
				<tr>
					...
					<td>
						...
						<asp:DropDownList id="gn" runat="server"></asp:DropDownList>
					</td>
				</tr>
				<tr>
					<td align="right" width="100">
					...
					<td>
						<asp:TextBox id="ids" runat="server" CssClass="inputcss" Width="64px"></asp:TextBox></td>
				</tr>
				<tr>
					...
					<td style="HEIGHT: 3px">
						<asp:TextBox id="idname" runat="server" CssClass="inputcss" Width="208px"></asp:TextBox></td>
				</tr>
			</table>
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
