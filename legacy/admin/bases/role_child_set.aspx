<%@ Page language="c#" Codebehind="role_child_set.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.role_child_set" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">角色表详细设置</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
					...
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" PageSize="50" Width="100%" Height="80px" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="pagename" HeaderText="功能页面"></asp:BoundColumn>
								<asp:BoundColumn DataField="idname" HeaderText="功能按钮"></asp:BoundColumn>
								<asp:BoundColumn DataField="power" HeaderText="操作权限"></asp:BoundColumn>
							</Columns>
