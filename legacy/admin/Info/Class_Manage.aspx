...
<%@ Page language="c#" Codebehind="Class_Manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.Info.Class_Manage" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">咨询类别设置</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="title3">
					...
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" PageSize="50" Width="100%" Height="80px" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="id" HeaderText="当前类"></asp:BoundColumn>
								<asp:BoundColumn DataField="parentid" HeaderText="父类"></asp:BoundColumn>
								<asp:BoundColumn DataField="des" HeaderText="咨询类名"></asp:BoundColumn>
								<asp:BoundColumn DataField="judge1" HeaderText="审批人"></asp:BoundColumn>
								<asp:BoundColumn DataField="judge2" HeaderText="审批人2" Visible="False"></asp:BoundColumn>
				...
				<tr>
					<td align="center">&nbsp;&nbsp;&nbsp;
						...
						<asp:Button id="judge" runat="server" CssClass="buttoncss" Height="24" Width="80px" Text="审批管理"></asp:Button>
					</td>
					</TD>
				</tr>
			</table>
