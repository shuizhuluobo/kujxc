...
<%@ Page language="c#" Codebehind="xwdt_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.info.xwdt_manage" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">公告内容管理</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="title3">
				...
				<tr>
					<td align="center">
						...
						&nbsp;&nbsp;&nbsp;
						<asp:Button id="add" runat="server" Height="23px" Width="72px" Text="增加" CssClass="buttoncss"></asp:Button>&nbsp;&nbsp;&nbsp;
						<asp:Button id="delete" runat="server" Height="23px" Width="72px" Text="删除" CssClass="buttoncss"></asp:Button>&nbsp;&nbsp;&nbsp;
						<asp:Button id="change" runat="server" Height="23px" Width="72px" Text="预览修改" CssClass="buttoncss"></asp:Button>&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
			</table>
		</form>
