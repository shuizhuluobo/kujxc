...
<%@ Page language="c#" Codebehind="Class_add.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.Info.Class_add" %>
		...
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">咨询类增加</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table cellpadding="0" cellspacing="5" border="0" width="100%" class="title3">
				...
				<tr>
					...
					<td>
						<asp:RadioButtonList id="Radiobuttonlist2" runat="server" CssClass="title3">
