...
<%@ Page language="c#" Codebehind="xwdt_change.aspx.cs" AutoEventWireup="false" validateRequest="false" Inherits="jxc.admin.info.xwdt_change" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Post" method="post" runat="server">
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="title3">
				<tr>
					<td align="center" colspan="2">内容维护</td>
				</tr>
			</table>
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="title3">
				<TR>
				...
				<tr>
					<td></td>
					<td align="left">&nbsp;
						<asp:Button id="Button2" runat="server" Width="64px" Text="修改" Height="24px" CssClass="buttoncss"></asp:Button>&nbsp;<INPUT style="WIDTH: 64px; HEIGHT: 24px" type="button" value="返回" onclick="closes()" class="buttoncss">
					</td>
				</tr>
			</table>
		</form>
