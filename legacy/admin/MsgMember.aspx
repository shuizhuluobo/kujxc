<%@ Page language="c#" Codebehind="MsgMember.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.MsgMember" %>
				...
				<tr>
					<td background="../Images/treetopbg.jpg">
						<table class="GbText" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td align="center" width="30"><IMG height="16" src="../Image/page.gif" width="16"></td>
								<td>&nbsp;
						...
						<TABLE id="tnb" style="BORDER-RIGHT: #93bee2 1px; BORDER-TOP: #93bee2 1px; BORDER-LEFT: #93bee2 1px; WIDTH: 100%; BORDER-BOTTOM: #93bee2 1px; BORDER-COLLAPSE: collapse; BACKGROUND-COLOR: white"
							...
							<TR style="FONT-SIZE: x-small; COLOR: black; BACKGROUND-COLOR: #e8f4ff" vAlign="middle"
								...
								<TD style="FONT-SIZE: x-small" align="left"><FONT face="宋体">&nbsp; </FONT>
									<asp:textbox id="txtRealName" runat="server" Width="272px" CssClass="InputCss"></asp:textbox><asp:textbox id="txtMsgID" runat="server" Visible="False" Width="7px"></asp:textbox><asp:textbox id="txtSender" runat="server" Visible="False" Width="9px"></asp:textbox></TD>
							</TR>
							...
							<TR style="FONT-SIZE: x-small; COLOR: black; BACKGROUND-COLOR: white" vAlign="middle"
								...
								<TD style="FONT-SIZE: x-small; WIDTH: 50px" align="left">
									<asp:button Visible="False" id="btnHistory" runat="server" Enabled="False" Text="历史记录" CssClass="greenButtonCss"></asp:button></TD>
								<TD align="left" style="FONT-SIZE: x-small">&nbsp;
									<asp:button Visible="False" id="btnReply" runat="server" Enabled="False" Text="回复" CssClass="redButtonCss"></asp:button>&nbsp;
									<asp:button id="btnNext" runat="server" Enabled="False" Text="下一条" CssClass="redButtonCss"></asp:button>&nbsp;
									<asp:button id="btnRead" runat="server" Text="我知道啦!" CssClass="redButtonCss"></asp:button>
									<asp:Label id="Label1" runat="server" Visible="False">Label</asp:Label>
									<asp:Label id="Labelmemcode" runat="server" Visible="False"></asp:Label></TD>
							</TR>
						</TABLE>
					</td>
				</tr>
