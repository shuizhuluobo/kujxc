<%@ Page language="c#" Codebehind="view_judge.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.view_judge" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="4" border="0" width="100%" class="title3">
				...
				<tr>
					<td width="70">正文</td>
					<td><FONT face="宋体">
							<asp:TextBox id="nr" runat="server" TextMode="MultiLine" Width="480px" Height="160px"></asp:TextBox></FONT></td>
				</tr>
				<tr>
