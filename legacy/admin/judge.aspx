<%@ Page language="c#" Codebehind="judge.aspx.cs" AutoEventWireup="false" validateRequest="false"  Inherits="jxc.admin.judge" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table class="title3" cellSpacing="6" cellPadding="0" width="100%" border="0">
				...
				<tr>
					<td colSpan="2"><asp:button id="savesp" runat="server" CssClass="buttoncss" Text="保存审批"></asp:button>&nbsp;<INPUT class="buttoncss" style="WIDTH: 64px; HEIGHT: 24px" onclick="closes()" type="button"
							value="返回">
					</td>
				</tr>
			</table>
