<%@ Page language="c#" Codebehind="MsgManage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.MsgManage" %>
						...
						<TABLE id="tnb" style="BORDER-RIGHT: #93bee2 1px; BORDER-TOP: #93bee2 1px; BORDER-LEFT: #93bee2 1px; WIDTH: 100%; BORDER-BOTTOM: #93bee2 1px; BORDER-COLLAPSE: collapse; BACKGROUND-COLOR: white"
							...
							<TR style="FONT-SIZE: x-small; COLOR: black; BACKGROUND-COLOR: white" vAlign="middle"
								...
								<TD style="FONT-SIZE: x-small; WIDTH: 50px" align="left">
									<asp:button id="btnHistory" runat="server" Enabled="False" Text="历史记录" CssClass="greenButtonCss"
										Visible="False"></asp:button></TD>
								<TD align="left" style="FONT-SIZE: x-small">&nbsp;
									<asp:button id="btnReply" runat="server" Enabled="False" Text="回复" CssClass="redButtonCss" Visible="False"></asp:button>&nbsp;
									...
									<asp:Label id="Labelmemcode" runat="server" Visible="False"></asp:Label>
