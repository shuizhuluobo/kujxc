<%@ Page language="c#" Codebehind="role_dis.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.role_dis" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>角色权限管理主页面</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">角色操作权限管理</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td align="center">
						选择角色:<asp:DropDownList id="DropDownList1" runat="server" Width="120px" AutoPostBack="True"></asp:DropDownList>
