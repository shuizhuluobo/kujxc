<%@ Control Language="c#" AutoEventWireup="false" Codebehind="dt_pj_o.ascx.cs" Inherits="health.admin.member.dt_pj_o" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<asp:panel id="Panel1" runat="server">老年组评价表，年龄段：60岁及以上 
			...
			<TD>
				<asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Width="100%" BorderColor="#000066"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="CLXT_SG" HeaderText="身高"></asp:BoundColumn>
