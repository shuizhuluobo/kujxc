<%@ Page language="c#" Codebehind="center_pj.aspx.cs" AutoEventWireup="false" Inherits="health.admin.member.center_pj" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD align="left">单&nbsp;&nbsp; 位：
						<asp:dropdownlist id="dw" runat="server"></asp:dropdownlist>&nbsp;&nbsp;&nbsp; 
						性别：
