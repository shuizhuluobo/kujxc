<%@ Control Language="c#" AutoEventWireup="false" Codebehind="dt_jc_o.ascx.cs" Inherits="health.admin.member.dt_jc_o" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<asp:Panel id="Panel1" runat="server">
老年组检查表，年龄段：60岁及以上  身份证号：<%=sfzh%>
