<%@ Control Language="c#" AutoEventWireup="false" Codebehind="dt_jc_ab.ascx.cs" Inherits="health.admin.member.dt_jc_ab" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<asp:panel id="Panel1" runat="server">成年B组检查表，年龄段：40～59岁 身份证号：<%=sfzh%> 
