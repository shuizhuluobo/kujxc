...
{
	/// <summary>
	/// enterprise_manage 的摘要说明。
	/// </summary>
	public class enterprise_manage : health.UsrControl.UserPage
	{
		protected System.Web.UI.WebControls.DataGrid Datagrid1;
		protected System.Web.UI.WebControls.Button query;
		protected System.Web.UI.WebControls.DropDownList ifjudge;
		protected dgNavigation DgNavigation1;
		protected System.Web.UI.WebControls.TextBox xm;
		protected System.Web.UI.WebControls.DropDownList dw;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				utils.BindDropDownList("select jgbh,jgmc from cnc_jgglb where parent1='0000'",this.dw);
				BindData ();
			}
		}
		...
		{
			string cmd = "select xm,sfzh,(case xb when 1 then '男' else '女' end) as xb,ywjb,nl,sfjc,jcrq,(select b_nlz.nlz from b_nlz where b_nlz.id=dt_grxx.nlz) as nlz,(select b_xl.xl from b_xl where b_xl.id=dt_grxx.xl) as xl,(select jgmc from cnc_jgglb where cnc_jgglb.jgbh=dt_grxx.jgbh) as dw from dt_grxx where 1=1";
			
			//单位
			if (this.dw.SelectedIndex != 0)
				cmd += " and jgbh='" + this.dw.SelectedItem.Value + "'";
			//姓名
			if (this.xm.Text != "")
