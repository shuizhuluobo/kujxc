<%@ Page language="c#" Codebehind="khdzd_managemx.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.khdzd_managemx" %>
			...
			<TABLE class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" Width="100%" CssClass="title3" Height="0px" BorderColor="#000066"
							DataKeyField="xsid" AutoGenerateColumns="False" PageSize="50">
