...
<%@ Page language="c#" Codebehind="khdzd_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.khdzd_manage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD style="WIDTH: 104px; HEIGHT: 23px"><FONT face="宋体"><asp:checkbox id="CheckBox1" runat="server" Checked="True" Text="按日期"></asp:checkbox></FONT></TD>
					<TD style="WIDTH: 343px; HEIGHT: 23px"><FONT face="宋体"><asp:textbox id="Textbox1" runat="server" Width="80px" CssClass="inputcss"></asp:textbox>到
				...
				<TR>
					...
					<TD align="right"><asp:button id="query" runat="server" Text="查询" Width="56px" CssClass="buttoncss" Height="24px"></asp:button>&nbsp;
						...
						<asp:button id="change" runat="server" Text="对帐确认" Width="64px" CssClass="buttoncss" Height="24"></asp:button><asp:button id="delete" runat="server" Text="删除" Width="40px" CssClass="buttoncss" Visible="False"
			...
			<TABLE class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" Width="100%" CssClass="title3" Height="0px" BorderColor="#000066"
							AllowPaging="True" DataKeyField="zdbm" AutoGenerateColumns="False" PageSize="50">
