...
<%@ Page language="c#" Codebehind="dqspdb_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.dqspdb_manage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">库房商品调拨</font></td>
							</tr>
						</table>
					</td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<tr>
					<td style="WIDTH: 79px"><FONT face="宋体">地区</FONT></td>
					<td style="WIDTH: 125px">
						<asp:dropdownlist id="DropDownListlx" runat="server" CssClass="inputcss" Width="128px" AutoPostBack="True"></asp:dropdownlist></td>
					<TD align="left"><FONT face="宋体">所在库房
							<asp:dropdownlist id="Dropdownlist1" runat="server" CssClass="inputcss" Width="128px"></asp:dropdownlist>&nbsp;</FONT></TD>
					...
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Height="0px" Width="100%" PageSize="50"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="店名" HeaderText="所在库房"></asp:BoundColumn>
