<%@ Page language="c#" Codebehind="dqspdb_edit.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.dqspdb_edit" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="dqspdb_edit" method="post" runat="server">
			...
			<table class="title3" cellSpacing="5" cellPadding="0" width="90%" align="center" border="0">
				...
				<TR>
					<TD align="right" width="100"><FONT face="宋体">颜色</FONT></TD>
					<TD><FONT face="宋体">
							<asp:textbox id="txtyanse" runat="server" ReadOnly="True" CssClass="inputcss" Width="96px" BackColor="#E0E0E0"></asp:textbox></FONT></TD>
					<TD><FONT face="宋体">款号</FONT></TD>
					<TD><FONT face="宋体">&nbsp;
							<asp:textbox id="txtkuanghao" runat="server" ReadOnly="True" CssClass="inputcss" Width="96px"
								BackColor="#E0E0E0"></asp:textbox></FONT></TD>
				</TR>
				<tr>
				...
				<TR>
					...
					<TD style="HEIGHT: 21px" colSpan="3"><FONT face="宋体"></FONT><FONT face="宋体"><asp:textbox id="Textbox7" runat="server" Width="409px" CssClass="inputcss" TextMode="MultiLine"
								Height="32px"></asp:textbox></FONT></TD>
				</TR>
			</table>
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
