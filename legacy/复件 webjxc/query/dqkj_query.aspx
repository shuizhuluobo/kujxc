...
<%@ Page language="c#" Codebehind="dqkj_query.aspx.cs" AutoEventWireup="false" Inherits="jxc.webjxc.query.dqkj_query" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">地区会计查询</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td><asp:dropdownlist id="DropDownList1" runat="server"></asp:dropdownlist>&nbsp;
						<asp:checkbox id="CheckBox1" runat="server" Text="按日期"></asp:checkbox><asp:textbox id="Textbox1" runat="server" CssClass="inputcss" Width="104px"></asp:textbox>到
...
<asp:ListItem Value="贷方">贷方</asp:ListItem>
					...
					<td align="right"><asp:button id="query" runat="server" Text="查询" CssClass="buttoncss" Width="72px"></asp:button><asp:button id="Button1" runat="server" Text="新增" CssClass="buttoncss" Width="72px" Visible="False"></asp:button>&nbsp;</td>
				</tr>
			</table>
			<br>
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD style="HEIGHT: 237px" align="right"><asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Width="100%" BorderColor="#000066"
							AllowPaging="True" DataKeyField="kjid" AutoGenerateColumns="False" Height="80px" PageSize="12">
						...
						</asp:datagrid><asp:label id="Label1" runat="server" ForeColor="Red" Font-Size="12pt"></asp:label></TD>
				</TR>
				<tr>
