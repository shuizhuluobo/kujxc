...
<%@ Page language="c#" Codebehind="yyymxb_query.aspx.cs" AutoEventWireup="false" Inherits="jxc.webjxc.query.yyymxb_query" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">月营业明细表</font></td>
							</tr>
						</table>
					</td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td style="WIDTH: 56px">店名
					</td>
					<td>&nbsp;
						<asp:TextBox id="dm" runat="server"></asp:TextBox>
					</td>
...
<asp:BoundColumn DataField="m_in" HeaderText="营业额" DataFormatString="{0:F2}">
<ItemStyle HorizontalAlign="Right">
</ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="m_out" HeaderText="成本" DataFormatString="{0:F2}">
<ItemStyle HorizontalAlign="Right">
</ItemStyle>
</asp:BoundColumn>
...
<asp:BoundColumn DataField="毛利率" HeaderText="毛利率">
<ItemStyle HorizontalAlign="Center">
</ItemStyle>
</asp:BoundColumn>
</Columns>
