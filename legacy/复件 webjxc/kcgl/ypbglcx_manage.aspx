<%@ Page language="c#" Codebehind="ypbglcx_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.ypbglcx_manage" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD style="WIDTH: 186px; HEIGHT: 25px"><asp:dropdownlist id="DropDownList2" runat="server"></asp:dropdownlist><FONT face="宋体"><asp:dropdownlist id="Dropdownlist1" runat="server" Visible="False"></asp:dropdownlist></FONT></TD>
					<TD style="HEIGHT: 25px" align="right"><FONT face="宋体"></FONT></TD>
				</TR>
				<tr>
					<td style="WIDTH: 79px">产品名称</td>
					<td style="WIDTH: 186px"><asp:textbox id="cpname" runat="server" CssClass="inputcss"></asp:textbox></td>
					<td align="right"><asp:button id="query" runat="server" CssClass="buttoncss" Height="24px" Width="72px" Text="查询"></asp:button></td>
				</tr>
			</table>
			<TABLE class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Height="0px" Width="100%" PageSize="50"
...
<HeaderStyle Font-Names="宋体" HorizontalAlign="Center" ForeColor="Purple">
</HeaderStyle>
...
<asp:BoundColumn DataField="仓库名称" HeaderText="地区">
