...
namespace jxc.admin.bases
{
	...
	/// thrkmx_manage 的摘要说明。
	/// </summary>
	public class thrkmx_manage :jxc.UsrControl.UserPage//System.Web.UI.Page//  
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!this.Page.IsPostBack)
			{
				...
				BindData ();
				send.Attributes.Add("onclick","return confirm('您真的要发送吗？')");
		...
		{
			string cmd = "select * from (SELECT a.[thid], a.[产品名称], a.[cpid],a.[产品型号], a.[退货数量],b.[退货日期],a.[rkid],a.[单价],a.[是否审核],b.[单据状态],a.[产品类别],b.客户名称,b.店名,b.经办人,b.地区,b.主管审核,b.总会计审核,b.销售单号,b.状态 FROM [退货单明细] as a,[退货单] as b where a.thid=b.thid ) as xx where 1=1 and 状态=1 ";
			if (this.cpname.Text != string.Empty)
				cmd += " and 客户名称 like '%" + this.cpname.Text.Trim () + "%'";
			if (this.Textbox2.Text != string.Empty)
				cmd += " and 产品名称 like '%" + this.Textbox2.Text.Trim () + "%'";
			...
			DataSet ds = DBBase.ExecuteSql4Ds (cmd,"thrkmx");
			this.Datagrid1.DataSource = ds.Tables["thrkmx"].DefaultView;
		...
		{
		string id = utils.FindFirstCheckedItem(this.Datagrid1);
//			u.OpenIEWindowRight(this,"thrkmx_edit.aspx?cpid=" + id,500,500);
				string cmd="update 退货单 set 到货确认='是' where thid='"+id+"'";
		...
		private void delete_Click(object sender, System.EventArgs e)
		{
			...
			string cmd="update 退货单 set 单据状态='发送',状态=2 where thid='"+id+"'";
			DBBase.ExecuteSql (cmd);
            BindData ();
		}
