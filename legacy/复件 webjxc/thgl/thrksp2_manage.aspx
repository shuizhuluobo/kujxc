...
<%@ Page language="c#" Codebehind="thrksp2_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.thrksp2_manage" %>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<tr>
					...
					<TD align="right"><asp:button id="query" runat="server" CssClass="buttoncss" Height="24px" Text="查询" Width="72px"></asp:button><asp:button id="change" runat="server" CssClass="buttoncss" Height="24" Text="退回单据" Width="80px"
							Visible="False"></asp:button><asp:button id="Button2" runat="server" CssClass="buttoncss" Height="24px" Text="审批退货单" Width="72px"></asp:button><asp:button id="send" runat="server" CssClass="buttoncss" Height="24px" Text="发送" Width="72px"
