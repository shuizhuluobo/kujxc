...
namespace jxc.admin.bases
{
	...
	/// cksh_add 的摘要说明。
	/// </summary>
	public class xsth_edit :jxc.UsrControl.UserPage//System.Web.UI.Page// 
	{
		...
		private void CodeSearch()
		{
			...
			if(!Page.IsPostBack)
			{
				...
				strScript = JSUtil.GetOpenDialogScript("客户选择","../CommonSearch/gysSelect.aspx",550,650,"Form1");
		...
		private void save_Click(object sender, System.EventArgs e)
		{
            ...
            string strcmd="insert into 销售单 ([xsid],[店名], [总计金额], [预付定金], [客户名称], [销售日期], [付款金额], [折扣率], [备注], [经办人], [找回], [审核通过], [地区],应付金额,wldwid,标志) values('";
			...
			strcmd+="否','";
			strcmd+=this.zjgmc.ToString()+"',"+this.Textbox5.Text+",'"+this.txtwldwid.Text+"','退货')";
			try
			{
...
//				u.OpenIEWindowRight(this,"cksh_zzxp.aspx?xsid="+Textbox2.Text,600,350);
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			//u.OpenIEWindowRight(this,"xsth_addmx.aspx?rkid="+Textbox2.Text,600,350);
			u.OpenIEWindowRight(this,"xsth_addmx.aspx?rkid="+Textbox2.Text,600,350);
            BindData ();
		}
