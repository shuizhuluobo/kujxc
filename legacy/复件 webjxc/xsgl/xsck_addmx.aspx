<%@ Page language="c#" Codebehind="xsck_addmx.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.xsck_addmx" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="xsck_addmx" method="post" runat="server">
			...
			<table class="title3" cellSpacing="5" cellPadding="0" width="90%" align="center" border="0">
				...
				<TR>
					<TD align="right" width="101" style="WIDTH: 101px">产品编码
					</TD>
					<TD><asp:textbox id="cpbm" runat="server" ReadOnly="True" CssClass="inputcss" Width="96px" BackColor="#E0E0E0"></asp:textbox><asp:textbox id="Textbox5" runat="server" CssClass="inputcss" Width="38px" BackColor="#E0E0E0"
				...
				<TR>
					<TD style="WIDTH: 101px; HEIGHT: 22px" align="right" width="101"><FONT face="宋体">数量</FONT></TD>
					<TD style="HEIGHT: 21px"><FONT face="宋体"><asp:textbox id="Textbox6" runat="server" CssClass="inputcss" Width="96px">0</asp:textbox></FONT></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 101px; HEIGHT: 22px" align="right" width="101">销售价格&nbsp;
					</TD>
					<TD style="HEIGHT: 21px">
						<asp:textbox id="Textbox3" runat="server" CssClass="inputcss" Width="96px">0</asp:textbox></TD>
				</TR>
				<TR>
