		...
		<form id="Form1" method="post" runat="server">
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD style="WIDTH: 138px; HEIGHT: 24px"><FONT face="宋体"><asp:textbox id="cpname" runat="server" CssClass="inputcss"></asp:textbox></FONT></TD>
					<TD style="WIDTH: 196px; HEIGHT: 24px" align="left">客户名称
				...
				<tr>
					...
					<TD align="right"><asp:button id="query" runat="server" CssClass="buttoncss" Width="72px" Text="查询" Height="24px"></asp:button><asp:button id="add" runat="server" CssClass="buttoncss" Width="72px" Text="录入销售单" Height="24px"></asp:button>
						<asp:button id="Button2" runat="server" Width="80px" CssClass="buttoncss" Height="24" Text="修改单据"></asp:button><asp:button id="change" runat="server" CssClass="buttoncss" Width="80px" Text="作废单据" Height="24"></asp:button><asp:button id="delete" runat="server" CssClass="buttoncss" Width="72px" Text="打印" Height="24px"></asp:button>&nbsp;</TD>
				</tr>
			</table>
			<TABLE class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
