<%@ Page language="c#" Codebehind="xsdb_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.xsdb_manage" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">销售调拨</font></td>
							</tr>
						</table>
					</td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td align="right"><asp:button id="query" runat="server" CssClass="buttoncss" Text="查询" Width="72px" Height="24px"></asp:button>
						<asp:button id="add" runat="server" CssClass="buttoncss" Text="销售调拨" Width="72px" Height="24px"></asp:button>
						<asp:button id="change" runat="server" CssClass="buttoncss" Text="确认审核" Width="80px" Height="24"></asp:button>
						<asp:button id="delete" runat="server" CssClass="buttoncss" Text="退货" Width="72px" Height="24px"
