...
namespace jxc.admin.bases
{
	...
	public class xsckmx_manage :jxc.UsrControl.UserPage//System.Web.UI.Page//  
	{
		...
		{
			string cmd = "select * from (SELECT a.[xsid], a.[产品名称], a.[cpid], a.[产品型号], a.[销售数量], a.[制作明细],a.[已调拨],b.[销售日期],a.[rkid],a.[单价],a.[是否审核],a.[产品类别],b.客户名称,b.店名,b.经办人,b.地区,b.到货确认,b.审核通过,b.总计金额,b.发票状态,b.收款状态,a.零售价,b.备注 FROM [销售单明细] as a,[销售单] as b where a.xsid=b.xsid and b.标志='正常' ) as xx where 1=1 ";
