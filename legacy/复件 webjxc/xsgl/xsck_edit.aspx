	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table class="title3" style="WIDTH: 657px; HEIGHT: 340px" borderColor="#003300" cellSpacing="2"
				...
				<tr>
					<td style="WIDTH: 102px; HEIGHT: 4px" align="right" width="102" height="4">销售单编号
					</td>
				...
				<tr>
					<td style="WIDTH: 102px; HEIGHT: 26px" align="right"><FONT face="宋体">应付金额</FONT></td>
				...
				<TR>
					<TD style="WIDTH: 102px; HEIGHT: 23px" align="right" width="102"></TD>
					<TD style="HEIGHT: 23px"><FONT face="宋体"></FONT></TD>
					<TD style="WIDTH: 59px; HEIGHT: 23px"><FONT face="宋体">备注</FONT></TD>
				...
				<TR>
					<TD style="WIDTH: 102px; HEIGHT: 4px" align="right" width="102"><FONT face="宋体">销售日期</FONT></TD>
					...
					<TD style="WIDTH: 59px; HEIGHT: 4px"><FONT face="宋体">经办人</FONT></TD>
