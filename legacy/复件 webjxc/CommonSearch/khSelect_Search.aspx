<%@ Page language="c#" Codebehind="khSelect_Search.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.khSelect_Search" %>
				...
				<TR>
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Height="0px" Width="584px" PageSize="40"
							AutoGenerateColumns="False" DataKeyField="客户ID" AllowPaging="True" BorderColor="#000066">
