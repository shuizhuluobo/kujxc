...
namespace jxc.admin.bases
{
	...
	/// spdb_manage 的摘要说明。
	/// </summary>
	public class spdb_manage : System.Web.UI.Page
	{
		...
		private void BindData ()
		{
			...
			DataSet ds = DBBase.ExecuteSql4Ds (cmd+" order by 入库日期 desc,rkid desc","spdb");
		...
		private void add_Click(object sender, System.EventArgs e)
		{
			...
			u.OpenIEWindowRight(this,"spdb_edit.aspx?rkid="+id,650,400);
			BindData();
