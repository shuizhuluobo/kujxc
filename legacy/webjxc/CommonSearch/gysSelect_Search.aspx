...
<%@ Page language="c#" Codebehind="gysSelect_Search.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.gysSelect_Search" %>
				...
				<TR>
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Height="0px" Width="584px" PageSize="40"
							AutoGenerateColumns="False" DataKeyField="供应商ID" AllowPaging="True" BorderColor="#000066">
