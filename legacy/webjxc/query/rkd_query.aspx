<%@ Page language="c#" Codebehind="rkd_query.aspx.cs" AutoEventWireup="false" Inherits="jxc.webjxc.query.rkd_query" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">入库单查询</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" BorderColor="#000066" AllowPaging="True" CssClass="title3"
							DataKeyField="rkid" AutoGenerateColumns="False" Height="80px" Width="100%" PageSize="12">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="rkid" HeaderText="入库单号"></asp:BoundColumn>
								...
								<asp:BoundColumn DataField="入库数量" HeaderText="入库数量">
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="入库单价" HeaderText="入库单价">
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="剩余数量" HeaderText="剩余数量">
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								</asp:BoundColumn>
