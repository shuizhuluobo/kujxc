...
namespace jxc.webjxc.query
{
	...
	/// spdb_query 的摘要说明。
	/// </summary>
	public class dbd_query  :jxc.UsrControl.UserPage//System.Web.UI.Page//     
	{
		...
		{
			string id = utils.FindFirstCheckedItem(this.Datagrid1);
			u.OpenIEWindowRight(this,"dbd_edit.aspx?dbid="+id,750,550);
		}
		...
		private void Datagrid1_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
			{
				...
				else
				{
					//  仅设置文本.
					//e.Item.Cells[2].Text = "";
					e.Item.Cells[10].Text = "未到";
					e.Item.Cells[10].ForeColor=System.Drawing.Color.Red;
				}
//				isManager = (string)DataBinder.Eval(e.Item.DataItem, "打印状态");
//
//				if (isManager == "已打印")
//				{
//					//  设置文本及背景颜色.
//					e.Item.Cells[12].Text = "已打";
...
//			if (id!=null)
//			{
//				u.OpenIEWindowPrint(this,"dbd_zzxp.aspx?dbid="+id,750,550);
//				//id = utils.FindFirstCheckedItem(this.Datagrid1);
//				string cmd="update 调拨单 set 打印状态='已打印' where dbid='"+id+"'";
//				DBBase.ExecuteSql (cmd);
//			}	
//			BindData ();
		}
