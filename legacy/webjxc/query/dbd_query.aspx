...
<%@ Page language="c#" Codebehind="dbd_query.aspx.cs" AutoEventWireup="false" Inherits="jxc.webjxc.query.dbd_query" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">调出查询</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
				...
				<tr>
					<td>&nbsp;
						<asp:dropdownlist id="Dropdownlist2" runat="server" Enabled="False" Visible="False">
							...
							<asp:ListItem Value="调出记录" Selected="True">调出记录</asp:ListItem>
				...
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" BorderColor="#000066" AllowPaging="True" CssClass="title3"
							...
							<Columns>
								...
								<asp:BoundColumn Visible="False" DataField="调拨说明" HeaderText="制作明细">
									<ItemStyle HorizontalAlign="Left"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="xsid" HeaderText="销售单号"></asp:BoundColumn>
								<asp:BoundColumn Visible="False" DataField="确认到货" HeaderText="到货状态">
									<ItemStyle Wrap="False"></ItemStyle>
								</asp:BoundColumn>
							</Columns>
