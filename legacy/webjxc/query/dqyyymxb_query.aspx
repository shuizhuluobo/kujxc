...
<%@ Page language="c#" Codebehind="dqyyymxb_query.aspx.cs" AutoEventWireup="false" Inherits="jxc.webjxc.query.dqyyymxb_query" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">(地区)月营业明细表</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
				...
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" BorderColor="#000066" AllowPaging="True" CssClass="title3"
							...
							<Columns>
								...
								<asp:BoundColumn Visible="False" DataField="预收定金" HeaderText="预收定金" DataFormatString="{0:F2}">
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								</asp:BoundColumn>
