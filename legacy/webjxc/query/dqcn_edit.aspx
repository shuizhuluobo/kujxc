<%@ Page language="c#" Codebehind="dqcn_edit.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.dqcn_edit" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="dqcn_edit" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">地区出纳</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table class="title3" cellSpacing="5" cellPadding="0" width="90%" align="center" border="0">
				...
				<TR>
					...
					<TD><asp:textbox id="zhaiyao" runat="server" BackColor="White" Width="96px" CssClass="inputcss"></asp:textbox>
						<asp:DropDownList id="DropDownList2" runat="server">
							<asp:ListItem Value="回款">回款</asp:ListItem>
							<asp:ListItem Value="其他" Selected="True">其他</asp:ListItem>
						</asp:DropDownList><FONT face="宋体">(如果选择回款,系统将自动生成总帐)</FONT></TD>
				</TR>
				<TR>
