...
<%@ Page language="c#" Codebehind="dqryyhzb_query.aspx.cs" AutoEventWireup="false" Inherits="jxc.webjxc.query.dqryyhzb_query" %>
		...
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">(地区)日营业汇总表</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td>&nbsp;
						<asp:TextBox id="dqmc" runat="server" CssClass="inputcss"></asp:TextBox>
						<asp:CheckBox id="CheckBox1" runat="server" Text="按日期"></asp:CheckBox>
						<asp:textbox id="Textbox1" runat="server" Width="104px" CssClass="inputcss"></asp:textbox>
					</td>
				...
				<TR>
					<TD align="right"><asp:datagrid id="Datagrid1" runat="server" BorderColor="#000066" AllowPaging="True" CssClass="title3"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="日期1" HeaderText="日期" DataFormatString="{0:d}"></asp:BoundColumn>
