...
namespace jxc.admin.bases.kcgl
{
	...
	/// spxb_hzmanage 的摘要说明。
	/// </summary>
	public class spxb_hzmanage :jxc.UsrControl.UserPage//System.Web.UI.Page// 
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			DgNavigation1.SetStyle(500, false);//10表示每页分10行，true表示无分页时自动隐藏
		...
		{
			string cmd = "select 供应商,sum(入库数量*进货价) as 金额,发票标志,付款标志 from 下拨单 where 标志='是'  ";
			...
			DataSet ds = DBBase.ExecuteSql4Ds (cmd+" group by 供应商,发票标志,付款标志 order by 金额 desc","spxb");
