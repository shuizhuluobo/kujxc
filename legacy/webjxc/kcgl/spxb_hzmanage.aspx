<%@ Page language="c#" Codebehind="spxb_hzmanage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.kcgl.spxb_hzmanage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD style="HEIGHT: 25px; WIDTH: 75px"><FONT face="宋体"><asp:checkbox id="Checkbox2" runat="server" Text="按供应商"></asp:checkbox></FONT></TD>
					<TD style="HEIGHT: 25px; WIDTH: 487px"><FONT face="宋体"><asp:textbox id="txtgys" runat="server" CssClass="inputcss"></asp:textbox></FONT></TD>
				...
				<TR>
					<TD style="HEIGHT: 14px; WIDTH: 75px"><FONT face="宋体">发票标志</FONT></TD>
					<TD style="HEIGHT: 14px; WIDTH: 487px"><asp:dropdownlist id="DropDownList1" runat="server">
							...
							<asp:checkbox id="Checkbox4" style="Z-INDEX: 0" runat="server" Text="未付款"></asp:checkbox></FONT></TD>
				...
				<TR>
					...
					<TD style="WIDTH: 487px"><asp:textbox id="cpname" runat="server" CssClass="inputcss"></asp:textbox></TD>
					<TD align="right"><asp:button id="query" runat="server" Text="查询" CssClass="buttoncss" Width="40px" Height="24px"></asp:button><asp:button id="add" runat="server" Text="产品订货" CssClass="buttoncss" Width="52px" Height="24px"
							Enabled="False"></asp:button><asp:button id="delete" runat="server" Text="单据作废" CssClass="buttoncss" Width="57px" Height="24px"></asp:button><asp:button id="btnedit" runat="server" Text="修改单据" CssClass="buttoncss" Width="56px" Height="24px"></asp:button><asp:button id="Button3" runat="server" Text="打印订单" CssClass="buttoncss" Width="56px" Height="24px"></asp:button></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 75px"></TD>
					<TD style="WIDTH: 487px"><FONT face="宋体"></FONT></TD>
					<TD align="right"><asp:button id="change" runat="server" Text="到货确认" CssClass="buttoncss" Width="56px" Height="24"
							Enabled="False"></asp:button><asp:button id="Button2" runat="server" Text="发票确认" CssClass="buttoncss" Width="56px" Height="24"
							Enabled="False"></asp:button><asp:button id="Button1" runat="server" Text="付款确认" CssClass="buttoncss" Width="56px" Height="24"
