<%@ Page language="c#" Codebehind="ypbgl_edit.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.ypbgl_edit" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="ypbgl_edit" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">添加样品</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table class="title3" cellSpacing="5" cellPadding="0" width="90%" align="center" border="0">
				...
				<TR>
					<TD align="right" width="100"><FONT face="宋体">入库日期</FONT></TD>
					<TD><FONT face="宋体">
				...
				<TR>
					<TD style="HEIGHT: 22px" align="right" width="100">&nbsp;入库店名
					</TD>
					<TD style="HEIGHT: 21px"><asp:dropdownlist id="DropDownList2" runat="server"></asp:dropdownlist></TD>
				</TR>
				<TR>
					<TD style="HEIGHT: 21px" align="right" width="100"><FONT face="宋体">入库米数</FONT></TD>
