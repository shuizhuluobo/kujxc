...
<%@ Page language="c#" Codebehind="btckcx_query.aspx.cs" AutoEventWireup="false" Inherits="jxc.webjxc.query.btckcx_query" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">布头库存查询</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD style="HEIGHT: 21px"><FONT face="宋体">
							<asp:CheckBox id="CheckBox1" runat="server" Text="库存数量" Checked="True"></asp:CheckBox>&gt;=
