		...
		<form id="Form1" method="post" runat="server">
			<div class="biaoti" align="center">
				...
				<table cellSpacing="0" cellPadding="0" width="600" border="0">
					...
					<TR valign="middle">
						<TD colspan="2" nowrap class="daziti"><strong>订货单位（乙方）</strong>:威海星通电子有限公司</TD>
						...
						<td height="25" class="daziti" style="WIDTH: 600px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr align="right" valign="bottom">
								  <td height="30" colspan="3"><table width="202" border="0" cellpadding="0" cellspacing="2" bordercolor="#000000">
                                    ...
                                    <tr>
                                      <td nowrap><span class="style4">开户行：交通银行威海分行营业部</span></td>
                                    </tr>
                                    <tr>
                                      <td nowrap><span class="style4">帐号: 006000018000046221</span></td>
                                    </tr>
                                    <tr>
                                      <td nowrap>&nbsp;</td>
                                    </tr>
								...
								<tr>
									...
									<td>&nbsp;</td>
									<td><div align="right">订货单位：威海星通电子有限公司</div>
									</td>
								</tr>
								<tr>
