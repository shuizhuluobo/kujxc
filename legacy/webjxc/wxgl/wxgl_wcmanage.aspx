<%@ Page language="c#" Codebehind="wxgl_wcmanage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.wxgl_wjmanage" %>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">维修记录</font></td>
							</tr>
						</table>
					</td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD style="HEIGHT: 25px; WIDTH: 139px"><FONT face="宋体">
							<asp:DropDownList id="DropDownList2" style="Z-INDEX: 0" runat="server">
								...
								<asp:ListItem Value="所有记录">所有记录</asp:ListItem>
					...
					<TD style="HEIGHT: 25px" align="left"><FONT face="宋体">&nbsp;
							...
							<asp:textbox id="txtdw" style="Z-INDEX: 0" runat="server" CssClass="inputcss"></asp:textbox></FONT></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD align="right"><asp:button id="query" runat="server" CssClass="buttoncss" Text="查询" Width="40px" Height="24px"></asp:button>&nbsp;
						<asp:button id="add" runat="server" CssClass="buttoncss" Text="登记维修记录" Width="72px" Height="24px"
					...
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Height="0px" Width="90%" PageSize="50"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="联系电话" ReadOnly="True" HeaderText="联系电话"></asp:BoundColumn>
								...
								<asp:BoundColumn Visible="False" DataField="登记日期" HeaderText="登记日期"></asp:BoundColumn>
								<asp:BoundColumn DataField="接货时间" ReadOnly="True" HeaderText="接收时间"></asp:BoundColumn>
								<asp:BoundColumn Visible="False" DataField="维修类别" HeaderText="维修类别"></asp:BoundColumn>
