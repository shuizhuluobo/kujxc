<%@ Page language="c#" Codebehind="thrksp2_edit.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.thrksp2_edit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>产品退货单(会计审核)</title>
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">产品退货单(会计审核)</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
...
<PagerStyle Visible="False">
							...
							</asp:datagrid></FONT><asp:button id="Button1" runat="server" CssClass="buttoncss" Width="62px" Text="新增" Visible="False"></asp:button><asp:button id="Button2" runat="server" CssClass="buttoncss" Width="62px" Text="删除" Visible="False"></asp:button>
						<asp:TextBox id="TextBox11" runat="server" Width="32px" Visible="False"></asp:TextBox></td>
				</tr>
				<tr>
				...
				<TR>
					<TD style="HEIGHT: 2px" align="right" colSpan="6"></TD>
				</TR>
				<tr>
