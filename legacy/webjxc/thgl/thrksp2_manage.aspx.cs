...
{
	/// <summary>
	/// thrksp2_manage 的摘要说明。
	/// </summary>
	public class thrksp2_manage :jxc.UsrControl.UserPage//System.Web.UI.Page//  
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!this.Page.IsPostBack)
			{
				...
				BindData ();
				send.Attributes.Add("onclick","return confirm('您真的确认同意退货？ 确认后将生成新的销售单,并无法回退!')");
		...
		{
			string cmd = "select * from (SELECT a.[thid], a.[产品名称], a.[cpid],a.[产品型号], a.[退货数量],b.[退货日期],a.[rkid],a.[单价],a.[是否审核],b.[单据状态],a.[产品类别],b.客户名称,b.店名,b.经办人,b.地区,b.主管审核,b.总会计审核,b.销售单号,b.状态 FROM [退货单明细] as a,[退货单] as b where a.thid=b.thid ) as xx where 1=1 and 状态=3 ";
			...
			DataSet ds = DBBase.ExecuteSql4Ds (cmd,"thrksp2");
			this.Datagrid1.DataSource = ds.Tables["thrksp2"].DefaultView;
		...
		private void delete_Click(object sender, System.EventArgs e)
		{
			string id = utils.FindFirstCheckedItem(this.Datagrid1);
			//u.OpenIEWindowPrint(this,"xsprint.aspx?id="+id,750,550);
			string cmd="update 退货单 set 单据状态='完结',状态=3,主会计审核='是' where thid='"+id+"'";
			DBBase.ExecuteSql (cmd);
			BindData ();
		}
...
//				}
	...
	//	u.OpenIEWindowPrint(this,"thrk_manage.aspx",750,550);
		...
		{
			string id = utils.FindFirstCheckedItem(this.Datagrid1);
			u.OpenIEWindowRight(this,"thrksp2_edit.aspx?thid="+id,750,550);
//			string id = utils.FindFirstCheckedItem(this.Datagrid1);
//			if (id!="")
//			{
