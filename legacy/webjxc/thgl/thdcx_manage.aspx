...
<%@ Page language="c#" Codebehind="thdcx_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.thdcx_manage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">退货入库审核</font></td>
							</tr>
						</table>
					</td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD style="WIDTH: 79px; HEIGHT: 24px">单号</TD>
					<TD style="WIDTH: 125px; HEIGHT: 24px"><FONT face="宋体"><asp:textbox id="Textbox1" runat="server" CssClass="inputcss"></asp:textbox></FONT></TD>
					<TD style="HEIGHT: 24px" align="right"><FONT face="宋体"><asp:button id="add" runat="server" CssClass="buttoncss" Height="24px" Text="录入退货单" Width="72px"
				...
				<tr>
					<td style="WIDTH: 79px"><FONT face="宋体">单据状态</FONT></td>
					<td style="WIDTH: 125px"><FONT face="宋体"><asp:dropdownlist id="Dropdownlist1" runat="server" CssClass="inputcss" Width="128px">
								<asp:ListItem Value="已完结">已完结</asp:ListItem>
								<asp:ListItem Value="未完结">未完结</asp:ListItem>
								<asp:ListItem Value="所有记录" Selected="True">所有记录</asp:ListItem>
							</asp:dropdownlist></FONT></td>
					<TD align="right"><asp:button id="query" runat="server" CssClass="buttoncss" Height="24px" Text="查询" Width="72px"></asp:button><asp:button id="change" runat="server" CssClass="buttoncss" Height="24" Text="退回单据" Width="80px"
							Visible="False"></asp:button><asp:button id="Button2" runat="server" CssClass="buttoncss" Height="24px" Text="审批退货单" Width="72px"
				...
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Height="0px" Width="100%" BorderColor="#000066"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="主管审核" HeaderText="主管审核">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
