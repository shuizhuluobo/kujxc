<%@ Page language="c#" Codebehind="thrksp_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.thrksp_manage" %>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD style="HEIGHT: 24px" align="right"><FONT face="宋体">
							<asp:button id="add" runat="server" CssClass="buttoncss" Width="72px" Text="录入退货单" Height="24px"
				...
				<TR>
					...
					<TD style="HEIGHT: 24px" align="right"><FONT face="宋体">
							<asp:button id="send" runat="server" CssClass="buttoncss" Width="72px" Text="审核通过" Height="24px"
								Visible="False"></asp:button>
							<asp:button id="change" runat="server" CssClass="buttoncss" Width="80px" Text="退回单据" Height="24"
								Visible="False"></asp:button>&nbsp;
				...
				<tr>
					...
					<TD align="right">
						<asp:button id="query" runat="server" CssClass="buttoncss" Width="72px" Text="查询" Height="24px"></asp:button>
						<asp:button id="Button2" runat="server" CssClass="buttoncss" Width="72px" Text="审批退货单" Height="24px"></asp:button>&nbsp;</TD>
				</tr>
			</table>
			<TABLE class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
