<%@ Page language="c#" Codebehind="xsthprint.aspx.cs" AutoEventWireup="false" Inherits="jxc.webjxc.xsgl.xsthprint" %>
					...
					<table cellSpacing="0" cellPadding="0" width="600" border="0">
						<TR>
							<TD height="20" colspan="4" class="daziti">
								<p align="center">- - -威海星通电子退货单- - -
									<asp:label id="Label12" runat="server" Visible="False">Label</asp:label></p>
							</TD>
						</TR>
						<tr>
							<td class="daziti">供应商名称:
								<asp:label id="Label4" runat="server"></asp:label></td>
							<td>&nbsp;</td>
							<td height="20" colspan="2" nowrap>
								<div align="right"><span class="daziti">
										<asp:label id="Label2" runat="server" Visible="False">Label</asp:label>出库日期:
										<asp:label id="Label3" runat="server">Label</asp:label><asp:label id="Label5" runat="server" Visible="False">Label</asp:label><asp:label id="Label1" runat="server" Visible="False">Label</asp:label></span></div>
							</td>
						</tr>
						<TR>
									...
									<tr>
										<td class="daziti" colSpan="13"><asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Width="500px" Height="0px" BorderColor="#000066"
												...
												<Columns>
													...
													<asp:BoundColumn DataField="零售价" HeaderText="单价" DataFormatString="{0:F0}">
														<HeaderStyle Wrap="False"></HeaderStyle>
														<ItemStyle Wrap="False"></ItemStyle>
														<FooterStyle Wrap="False" HorizontalAlign="Center" VerticalAlign="Middle"></FooterStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="金额" HeaderText="金额" DataFormatString="{0:F0}">
														<HeaderStyle Wrap="False"></HeaderStyle>
														<ItemStyle Wrap="False"></ItemStyle>
														<FooterStyle Wrap="False" HorizontalAlign="Center" VerticalAlign="Middle"></FooterStyle>
													</asp:BoundColumn>
								...
								<table cellSpacing="0" cellPadding="0" width="600" border="0">
									...
									<tr class="biaoti" bgColor="#ffffff">
										...
										<td colspan="2" class="daziti">&nbsp;&nbsp;
											<asp:Label ID="Label8" runat="server" Visible="False">Label</asp:Label>
										</td>
									</tr>
								</table>
							</td>
