<%@ Page language="c#" Codebehind="xsthsh_edit.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.xsthsh_edit" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="thsh" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">客户产品退货<FONT face="隶书" size="5">审核</FONT>单</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table class="title3" cellSpacing="2" cellPadding="0" width="657" align="center" border="1"
				...
				<tr>
					<td width="100" height="4" align="right" style="HEIGHT: 4px">退货单编号
					</td>
					<td style="WIDTH: 120px; HEIGHT: 4px"><FONT face="宋体"><asp:textbox id="Textbox2" runat="server" BackColor="#E0E0E0" Width="96px" CssClass="inputcss"></asp:textbox></FONT></td>
					<td colspan="2">店名</td>
				...
				<tr>
					<td colspan="6" align="right" style="HEIGHT: 22px">
						<div align="center"><FONT face="宋体">产品退货明细</FONT>
						</div>
					</td>
				</tr>
				<tr>
					<td colspan="6" align="left" style="HEIGHT: 159px"><FONT face="宋体"></FONT> <FONT face="宋体">
							<asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Width="100%" Height="0px" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="销售数量" HeaderText="退货数量"></asp:BoundColumn>
				...
				<tr>
					...
					<td style="WIDTH: 108px; HEIGHT: 23px"><FONT face="宋体">预付定金</FONT></td>
					<td colspan="3">
						...
						<asp:textbox id="Textbox11" runat="server" CssClass="inputcss" Width="32px" BackColor="#C0FFC0"
							Visible="False"></asp:textbox></td>
				</tr>
				<tr>
					<td style="HEIGHT: 23px" align="right" width="100"><FONT face="宋体">客户名称</FONT>
					</td>
					<td style="WIDTH: 120px; HEIGHT: 23px"><FONT face="宋体">
							<asp:textbox id="Textbox1" runat="server" CssClass="inputcss" Width="96px" BackColor="Transparent"></asp:textbox></FONT></td>
					<td style="WIDTH: 108px; HEIGHT: 23px"><FONT face="宋体">销售日期</FONT></td>
					...
					<td style="HEIGHT: 23px">
						<asp:textbox id="Textbox4" runat="server" CssClass="inputcss" Width="96px" BackColor="Transparent"></asp:textbox></td>
				</tr>
				<TR>
					<TD style="HEIGHT: 21px" align="right" width="100"><FONT face="宋体">客户电话</FONT></TD>
					<TD style="WIDTH: 120px; HEIGHT: 21px"><FONT face="宋体">
							<asp:textbox id="Textbox5" runat="server" CssClass="inputcss" Width="96px" BackColor="Transparent"></asp:textbox></FONT></TD>
					<TD style="WIDTH: 108px; HEIGHT: 21px"><FONT face="宋体">备注</FONT></TD>
				...
				<tr>
					...
					<td style="WIDTH: 120px; HEIGHT: 21px">
						<asp:textbox id="czy" runat="server" CssClass="inputcss" Width="96px" BackColor="Transparent"></asp:textbox></td>
					<td style="WIDTH: 108px; HEIGHT: 21px"><FONT face="宋体"></FONT></td>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD style="HEIGHT: 37px" align="center">
						<asp:button id="save" runat="server" CssClass="buttoncss" Width="62px" Text="审核通过"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="buttoncss" style="WIDTH: 64px; HEIGHT: 20px" onclick="closes()" type="button"
							value="返回">
					</TD>
				</TR>
			</TABLE>
