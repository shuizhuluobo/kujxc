...
<%@ Page language="c#" Codebehind="xsthshmx_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.xsthshmx_manage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5"><FONT face="隶书" size="5">退货出库审核</FONT></font></td>
							</tr>
						</table>
					</td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD style="WIDTH: 79px; HEIGHT: 23px">供应商名称</TD>
					<TD style="WIDTH: 239px; HEIGHT: 23px"><FONT face="宋体"><asp:textbox id="cpname" runat="server" CssClass="inputcss" Width="78px"></asp:textbox><FONT face="宋体">审核类型
					...
					<TD style="HEIGHT: 23px" align="right"><FONT face="宋体">
				...
				<tr>
					...
					<td style="WIDTH: 239px"><asp:dropdownlist id="DropDownListlx" runat="server" CssClass="inputcss" Width="78px"></asp:dropdownlist></td>
					<td align="right"><asp:button id="query" runat="server" CssClass="buttoncss" Width="48px" Height="24px" Text="查询"></asp:button><asp:button id="add" runat="server" CssClass="buttoncss" Width="56px" Height="24px" Text="确认回单"
							Visible="False"></asp:button><asp:button id="change" runat="server" CssClass="buttoncss" Width="56px" Height="24" Text="确认审核"></asp:button><asp:button id="delete" runat="server" CssClass="buttoncss" Width="40px" Height="24px" Text="打印"
				...
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Width="100%" Height="0px" BorderColor="#000066"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="xsid" HeaderText="退货单号"></asp:BoundColumn>
								...
								<asp:BoundColumn DataField="客户名称" HeaderText="供应商名称"></asp:BoundColumn>
								<asp:BoundColumn DataField="店名" HeaderText="店名"></asp:BoundColumn>
								<asp:BoundColumn DataField="销售日期" HeaderText="退货日期" DataFormatString="{0:d}"></asp:BoundColumn>
								<asp:BoundColumn DataField="经办人" HeaderText="经办人"></asp:BoundColumn>
								<asp:BoundColumn DataField="地区" HeaderText="库房"></asp:BoundColumn>
								<asp:BoundColumn Visible="False" DataField="是否回单" HeaderText="是否回单"></asp:BoundColumn>
