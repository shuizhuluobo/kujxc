<%@ Page language="c#" Codebehind="xsthmx_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.xsthmx_manage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">产品退货</font></td>
							</tr>
						</table>
					</td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD style="WIDTH: 79px; HEIGHT: 24px"><asp:label id="Label2" runat="server">商品名称</asp:label></TD>
					<TD style="WIDTH: 125px; HEIGHT: 24px"><FONT face="宋体"><asp:textbox id="cpname" runat="server" CssClass="inputcss"></asp:textbox></FONT></TD>
					<TD style="HEIGHT: 24px" align="left"><FONT face="宋体">供应商名称
						...
						<asp:textbox id="Textbox3" runat="server" CssClass="inputcss" Width="80px"></asp:textbox>
						<asp:Label id="Label3" runat="server">到</asp:Label>
						<asp:textbox id="Textbox2" runat="server" CssClass="inputcss" Width="80px"></asp:textbox></FONT></TD>
				</TR>
				<tr>
					...
					<TD align="right"><asp:button id="query" runat="server" CssClass="buttoncss" Width="72px" Text="查询" Height="24px"></asp:button><asp:button id="add" runat="server" CssClass="buttoncss" Width="72px" Text="录入退货单" Height="24px"></asp:button><asp:button id="change" runat="server" CssClass="buttoncss" Visible="False" Width="80px" Text="确认到货"
							Height="24"></asp:button><asp:button id="delete" runat="server" CssClass="buttoncss" Width="72px" Text="打印" Height="24px"></asp:button>&nbsp;</TD>
				</tr>
			</table>
			<TABLE class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD><asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Width="100%" Height="0px" PageSize="50"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="xsid" HeaderText="退货单号">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								...
								<asp:BoundColumn DataField="销售数量" HeaderText="退货数量" DataFormatString="{0:F2}">
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="零售价" HeaderText="退货价">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="销售日期" HeaderText="退货日期" DataFormatString="{0:d}">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="店名" HeaderText="退货店">
								...
								<asp:BoundColumn Visible="False" DataField="发票状态" HeaderText="发票状态"></asp:BoundColumn>
							</Columns>
