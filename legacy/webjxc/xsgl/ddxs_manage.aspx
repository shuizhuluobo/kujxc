<%@ Page language="c#" Codebehind="ddxs_manage.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.ddxs_manage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">订货销售</font></td>
							</tr>
						</table>
					</td>
			...
			<table class="title3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD style="WIDTH: 75px; HEIGHT: 25px"><FONT face="宋体">
							<asp:checkbox id="Checkbox2" runat="server" Text="按供应商"></asp:checkbox></FONT></TD>
					<TD style="WIDTH: 139px; HEIGHT: 25px"><FONT face="宋体">
							<asp:textbox id="txtgys" runat="server" CssClass="inputcss"></asp:textbox></FONT></TD>
					<TD style="HEIGHT: 25px" align="left"><FONT face="宋体">
							...
							<asp:checkbox id="Checkbox3" runat="server" Text="按客户"></asp:checkbox>
							<asp:textbox id="Textbox3" runat="server" CssClass="inputcss"></asp:textbox>
							<asp:checkbox id="Checkbox4" runat="server" Text="未转销售"></asp:checkbox></FONT></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD align="right"><asp:button id="query" runat="server" CssClass="buttoncss" Text="查询" Width="40px" Height="24px"></asp:button>&nbsp;
						<asp:button id="add" runat="server" CssClass="buttoncss" Text="转销售单" Width="56px" Height="24px"></asp:button>&nbsp;
					...
					<TD>
						<asp:datagrid id="Datagrid1" runat="server" CssClass="title3" Height="0px" Width="100%" PageSize="50"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="销售标志" HeaderText="销售标志"></asp:BoundColumn>
