...
namespace jxc.admin.bases
{
	...
	/// xsck_manage 的摘要说明。
	/// </summary>
	public class xsck_manage :jxc.UsrControl.UserPage//System.Web.UI.Page//  
	{
		...
		private void BindData ()
		{
			...
			DataSet ds = DBBase.ExecuteSql4Ds (cmd,"xsck");
			this.Datagrid1.DataSource = ds.Tables["xsck"].DefaultView;
		...
		{
		string id = utils.FindFirstCheckedItem(this.Datagrid1);
//			u.OpenIEWindowRight(this,"xsck_edit.aspx?cpid=" + id,500,500);
