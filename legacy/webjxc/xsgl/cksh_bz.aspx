<%@ Page language="c#" Codebehind="cksh_bz.aspx.cs" AutoEventWireup="false" Inherits="jxc.admin.bases.cksh_bz" %>
		...
		<form id="cksh" method="post" runat="server">
				...
				<tr>
					<td width="556" background="/image/title.gif">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td width="80"></td>
								<td><font face="隶书" size="5">产品销售单-确认回单</font></td>
							</tr>
						</table>
					</td>
					<td width="250"></td>
			...
			<table class="title3" cellSpacing="2" cellPadding="0" width="657" align="center" border="1"
				...
				<tr>
					...
					<td style="HEIGHT: 4px"><FONT face="宋体"><asp:textbox id="Textbox2" runat="server" BackColor="#E0E0E0" Width="96px" CssClass="inputcss"
				...
				<tr>
					...
					<td colspan="3">
						...
						<asp:textbox id="Textbox10" runat="server" CssClass="inputcss" Width="17px" Visible="False"></asp:textbox></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="WIDTH: 59px; HEIGHT: 21px"><FONT face="宋体">送货人</FONT></td>
					<td colspan="3" style="HEIGHT: 21px">
						<asp:textbox id="Textbox11" runat="server" CssClass="inputcss" Width="96px" BackColor="#C0FFC0"></asp:textbox><FONT face="宋体">备注1
							<asp:textbox id="Textbox12" runat="server" CssClass="inputcss" Width="189px" BackColor="Transparent"></asp:textbox></FONT>
					</td>
				</tr>
			</table>
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD style="HEIGHT: 37px" align="center"><asp:button id="save" runat="server" Width="62px" CssClass="buttoncss" Text="确认回单"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="buttoncss" style="WIDTH: 64px; HEIGHT: 20px" onclick="closes()" type="button"
							value="返回">
					</TD>
				</TR>
			</TABLE>
