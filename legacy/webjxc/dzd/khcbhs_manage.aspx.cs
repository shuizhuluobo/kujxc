...
namespace jxc.admin.bases
{
	...
	/// khcbhs_manage 的摘要说明。
	/// </summary>
	public class khcbhs_manage : jxc.UsrControl.UserPage//System.Web.UI.Page
	{
...
string cmd="select *,出库数量 * 零售价 as 金额,出库数量 * 进货价 as 成本金额   from (SELECT [xsid], [销售日期],[客户名称],[店名],地区,  [cpid],  ";
...
//	    
		...
		{
			u.OpenIEWindowPrint(this,"khcbhs_managemx.aspx",800,600);
		}
