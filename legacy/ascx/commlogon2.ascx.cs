namespace jxc.ascx
{
	...
	///		commlogon2 的摘要说明。
	/// </summary>
	public class commlogon2 : System.Web.UI.UserControl
	{
		...
		{
			utils.BindDropDownList2("select number,countingroomname from System_DataBases where ynuse=1",this.DropDownList1);
