...
namespace jxc.admin.info
{
	...
	/// ggxx_manage 的摘要说明。
	/// </summary>
	public class ggxx_manage : jxc.UsrControl.UserPage
	{
		...
		{
			string direction = "ggxx_add.aspx?id=" + this.Request.QueryString["id"];
...
//			}
			...
			{   
				e.Item.Cells[1].Text="<a   href='ggxx.aspx?Id="+e.Item.Cells[0].Text+"'   target=\"_blank\">"+e.Item.Cells[1].Text+"</a>";   
			}   
		...
		private void change_Click(object sender, System.EventArgs e)
		{
			if (this.Page.IsPostBack)
			{
				...
				string direction = "ggxx_change.aspx?bh=" + id;
				u.OpenIEWindowRight (this,direction,580,500);
			}
		}
