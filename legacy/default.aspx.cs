		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if (this.Page.IsPostBack)
			{
				try
				{
					...
					cmd = "select glymm,glyname,b.parent1,b.jgbh,b.jgmc,b.rank,b.ifend,a.rank as judger,groupid,roleid from CNC_glyb a,cnc_jgglb b where a.jgbh=b.jgbh and glydh='" + this.Commlogon1.UserId + "'";
