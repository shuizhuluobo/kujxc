...
<%@ Page language="c#" Codebehind="one.aspx.cs" AutoEventWireup="false" Inherits="health.one" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="770" align="center" border="0">
				<tr>
					<td vAlign="top" width="185" height="500" background="zhu/back.jpg">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td><IMG src="zhu/1.jpg" border="0"></td>
							</tr>
							<tr>
								<td background="zhu/menu.gif" height="28"></td>
							</tr>
						</table>
					</td>
					<td vAlign="top" width="543">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td background="zhu/intro.jpg" height="103">
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										...
										<tr>
											<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<font color=white><b><%=des%></b></font></td>
										</tr>
									</table>
								</td>
							</tr>
