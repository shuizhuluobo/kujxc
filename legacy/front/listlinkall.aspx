...
<%@ Register TagPrefix="uc1" TagName="listlinkall" Src="../zxwd/listlinkall.ascx" %>
				...
				<tr>
					...
					<td vAlign="top" width="543">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td><span class="style1">您的位置：</span> <a href="default.aspx">首页</a> &gt;&gt;&nbsp;友情链接
							...
							<tr>
								<td>&nbsp;
									<uc1:listlinkall id="Listlinkall1" runat="server"></uc1:listlinkall></td>
							</tr>
						</table>
					</td>
