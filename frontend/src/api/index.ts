...
export const usersApi = {
    ...
    delete: (id: string) => api.delete<{ message: string; action: 'deleted' | 'disabled' | 'already_disabled'; hasAssociation: boolean }>(`/users/${id}`),
    canDelete: (id: string) => api.get<{ canHardDelete: boolean; hasAssociation: boolean }>(`/users/${id}/can-delete`),
...
export const performanceApi = {
    ...
    createRecords: (projectId: string, data: CreateWorkRecordsDto) =>
        api.post<{ created: WorkRecord[]; summary: { recorded: number; applied: number; skipped: number } }>(`/performance/projects/${projectId}/records/batch`, data),
